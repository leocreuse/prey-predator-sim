...
public class Simulation {
	...
	public static final int NB_STEPS = 20 * 24;
	...
	public Simulation(int nbPrey, int nbPred, Cst cst) {
		...
		// preys.add(new Prey(200,200,0,0));
		// preys.add(new Prey(201,201,0,0));
		/**
	...
	public void update() {
		System.out.println("Step: " + step + "; Preys: " + preys.size() + " ; Predators: " + preds.size());
