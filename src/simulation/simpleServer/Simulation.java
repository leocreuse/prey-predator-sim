...
public class Simulation {
	...
	public static final double TIME_STEP = 1. / 12.;

	public static final Color BACKGROUND = Color.WHITE;

	public static final int NB_STEPS = 20 * 12;
	...
	public Simulation(int nbPrey, int nbPred, Cst cst) {
		...
		try {
		 ...
		 //preys.add(new Prey(301,201,0,0,cst));
		/**
	...
	public void update() {
		System.out.print("\rStep: " + step + "; Preys: " + preys.size() + " ; Predators: " + preds.size());
